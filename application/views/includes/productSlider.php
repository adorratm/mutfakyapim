                        ...
                        <?php foreach ($data as $key => $value) : ?>
                            <div class="productItem01 rounded border p-3 h-100 shadow-sm">
                                ...
                                <div class="pi01Details">
                                    <h3 class="text-center"><a class="text-center" rel="dofollow" title="<?= $value->title ?>" href="<?= base_url(lang("routes_products") . "/" . lang("routes_product") . "/" . $value->seo_url) ?>"><?= $value->title ?></a></h3>
