...
{
    public $tableName = "service_details";
    public function __construct()
    {
        parent::__construct();
        $this->column_order = ['id', 'description', 'content', 'features', 'createdAt', 'updatedAt'];
        // Set searchable column fields
        $this->column_search = ['id', 'description', 'content', 'features', 'createdAt', 'updatedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
