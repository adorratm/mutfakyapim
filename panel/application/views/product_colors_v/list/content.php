...
<div class="container-fluid mt-xl-50 mt-lg-30 mt-15 bg-white p-3">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <h4 class="mb-3">
                Ürün Renkleri
                <a href="javascript:void(0)" data-url="<?= base_url("product_colors/getColors"); ?>" class="btn btn-sm btn-outline-primary rounded-0 btn-sm float-right syncProductColorBtn"> <i class="fa fa-rotate"></i> Ürün Rengi Ekle</a>
            </h4>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
