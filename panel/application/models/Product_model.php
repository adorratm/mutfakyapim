...
class Product_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'title', 'brand', 'collection', 'pattern', 'color', 'dimension', 'isActive', 'updatedAt'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'title', 'brand', 'collection', 'pattern', 'color', 'dimension', 'isActive', 'updatedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
