            ...
            <div class="col-xl-12 text-center justify-content-center">
                <div class="error-page__inner">
                    <div class="error-page__title-box">
                        <h2 class="error-page__title"><?= lang("payment_success") ?></h2>
                        <h2 class="error-page__title-2"><?= lang("payment_success") ?></h2>
                    </div>
                    ...
                    <h3 class="error-page__tagline"><?= lang("paymentSuccessMessage") ?></h3>
