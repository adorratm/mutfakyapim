            ...
            <div class="col-lg-12">
              <div class="card card-refresh">
                ...
                <div class="card-body">
                  <Datatable
                    :dataurl="
                      $config.API_URL + 'backend/codesController/datatable'
                    "
                    :rankurl="
                      $config.API_URL + 'backend/codesController/rank/'
                    "
                    :isactiveurl="
                      $config.API_URL + 'backend/codesController/isactive/'
                    "
                    :editurl="'/panel/codes/update/'"
                    :deleteurl="$config.API_URL + 'panel/codes/delete/'"
