              ...
              <div class="card card-refresh">
                ...
                <div class="card-body">
                  <Datatable
                    :dataurl="
                      $config.API_URL +
                      'panel/pages/datatable'
                    "
                    :rankurl="
                      $config.API_URL + 'panel/pages/rank/'
                    "
                    :isactiveurl="
                      $config.API_URL +
                      'panel/pages/isactive/'
                    "
                    :editurl="'/panel/pages/update/'"
                    :deleteurl="$config.API_URL + 'panel/pages/delete/'"
  ...
  data() {
    return {
      columns: [
        ...
        {
          label: this.$i18n.t("panel.pages.title"),
          field: "title",
          html: true,
          type: "string",
        },
