...
<section class="pageBannerSection" style="background-image: url(<?= !empty($products_collection) && !empty($products_collection->img_url) ? get_picture("product_categories_v", $products_collection->banner_url) : get_picture("settings_v", $settings->product_logo) ?>);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<form class="w-100" id="searchProductForm" action="<?= !empty($this->uri->segment(4) && !is_numeric($this->uri->segment(5))) ? base_url(lang("routes_products") . "/" . $this->uri->segment(3) . "/" . $this->uri->segment(4) . "/" . $this->uri->segment(5)) : base_url(lang("routes_products") . "/" . $this->uri->segment(3) . "/" . $this->uri->segment(4)) ?>" method="GET" enctype="multipart/form-data">
                ...
                <div class="col-sm-5 col-md-4 col-lg-3 col-xl-2">
                    <div class="shopSidebar">
                        ...
                        <aside class="widget">
                            ...
                            <?php if (!empty($_GET)) : ?>
                                <a rel="dofollow" title="<?= lang("clearFilter") ?>" class="btn btn-outline-danger mt-2 text-center w-100 fs-5" href="<?= base_url(lang("routes_products") . "/" . $this->uri->segment(3) . "/" . $this->uri->segment(4)) ?>"><?= lang("clearFilter") ?></a>
                            <?php endif ?>
                        </aside>
                    </div>
                </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3 my-3">
                                    <div class="productItem01 rounded border p-3 h-100 shadow-sm">
                                        ...
                                        <div class="pi01Details">
                                            <h3 class="text-center fw-medium fs-6"><a href="<?= base_url(lang("routes_products") . "/" . lang("routes_product") . "/" . $value->seo_url) ?>" rel="dofollow" title="<?= $value->title ?>"><?= $value->title ?></a></h3>
                                            <?php if (get_active_user()) : ?>
