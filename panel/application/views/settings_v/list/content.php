            ...
            <form id="filter_form" onsubmit="return false">
                <div class="d-flex flex-wrap">
                    ...
                    <label for="search_button" class="mx-1">
                        <button class="btn btn-sm btn-outline-success rounded-0 " onclick="reloadTable('settingsTable')" id="search_button" data-toggle="tooltip" data-placement="top" data-title="Ayar Ara"><i class="fa fa-search"></i></button>
                </div>
            </form>
