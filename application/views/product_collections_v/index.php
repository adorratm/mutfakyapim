...
<section class="pageBannerSection" style="background-image: url(<?= get_picture("settings_v", $settings->category_logo) ?>);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
    ...
    <div class="container-fluid px-5">
        <div class="row shopAccessRow align-items-center align-content-center align-self-center shadow p-2">
            ...
            <div class="col-sm-12 col-md-5 col-lg-6 col-xl-7 d-xl-flex my-2">
                <form class="w-100" id="searchCategoryForm" action="<?= !empty($this->uri->segment(3) && !is_numeric($this->uri->segment(3))) ? base_url(lang("routes_products") . "/" . $this->uri->segment(3)) : base_url(lang("routes_products")) ?>" method="GET" enctype="multipart/form-data">
            ...
            <div class="col-sm-12 col-md-5 col-lg-4 col-xl-3 my-2">
                <div class="shopAccessBar">
                    <div class="sortNav">
                        ...
                        <select name="productFilter" onchange="$('#searchCategoryForm').find('input[name=orderBy]').val($(this).val());$('#searchCategoryForm').submit()">
        ...
        <?php if (empty($product_categories)) : ?>
            <div class="alert alert-warning rounded-0 shadow" role="alert">
                ...
                <p><?= lang("weCantFindAnyProductCategoriesWithYourSearch") ?></p>
                <hr>
                <p class="mb-0"><?= lang("youCanSearchDifferentProductCategories") ?></p>
            </div>
        <?php endif ?>
