        ...
        if (!empty($items)) :
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu rounded-0 dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item updateProductCollectionBtn" href="javascript:void(0)" data-url="' . base_url("product_categories/update_form/$item->id") . '"><i class="fa fa-pen mr-2"></i>Kaydı Düzenle</a>
                </div>
            </div>';
